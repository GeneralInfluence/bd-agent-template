...
The campaign file should contain:
- Event metadata (dates, venue, organizers, contact emails)
- High / Medium / Low priority leads with full lead records
- Research gaps flagged for human follow-up
- Campaign timeline with dates
- Raw data appendix (all speakers, all sponsors, even unqualified ones)

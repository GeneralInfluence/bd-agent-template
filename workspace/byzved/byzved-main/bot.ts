...
bot.on('message', async (ctx, next) => {
  ...
  if (
    ...
    const notice =
      'Thank you for adding <b>RaidGuild_bot</b> to your group!\n\n' +
      '<b>Important:</b> To enable full functionality, please <b>promote RaidGuild_bot to admin</b> and grant it the <b>Read Messages</b> permission.\n\n' +
      'Without admin rights, the bot cannot read group messages or provide answers.\n\n' +
      'You can ask questions by mentioning @RaidGuild_bot in the group, or DM it directly.\n\n' +
      'Thank you!';
    try {
